...
export declare const redisClient: import("@redis/client").RedisClientType<{
    json: {
        ...
        MGET: {
            ...
            readonly transformReply: (this: void, reply: (import("@redis/client/dist/lib/RESP/types").NullReply | import("@redis/client/dist/lib/RESP/types").BlobStringReply<string>)[]) => (import("@redis/client/dist/lib/RESP/types").NullReply | import("@redis/json/dist/lib/commands").RedisJSON)[];
        };
        mGet: {
            readonly IS_READ_ONLY: true;
            readonly parseCommand: (this: void, parser: import("redis").CommandParser, keys: import("redis").RedisArgument[], path: import("redis").RedisArgument) => void;
    ...
    topK: {
        ...
        readonly INCRBY: {
            ...
            readonly transformReply: () => import("@redis/client/dist/lib/RESP/types").ArrayReply<import("@redis/client/dist/lib/RESP/types").SimpleStringReply<string> | import("@redis/client/dist/lib/RESP/types").NullReply>;
        };
        readonly incrBy: {
            readonly IS_READ_ONLY: false;
            readonly parseCommand: (this: void, parser: import("redis").CommandParser, key: import("redis").RedisArgument, items: import("@redis/bloom/dist/lib/commands/top-k/INCRBY").TopKIncrByItem | import("@redis/bloom/dist/lib/commands/top-k/INCRBY").TopKIncrByItem[]) => void;
...
export declare const testCounter: Counter<string>;
export declare function createTestServices(): Promise<{
    emailService: EmailService;
    metricsService: QueueMetricsService;
    retryStrategyService: RetryStrategyService;
    emailQueue: EmailQueueService;
}>;
export declare function cleanupRedis(): Promise<void>;
export declare function waitForRedis(ms?: number): Promise<void>;
export declare function waitForMetric(metricName: string, timeout?: number): Promise<boolean>;
