...
const TemporalSequencer_1 = require("./services/TemporalSequencer");
const CodexAccess_1 = require("./services/CodexAccess");
async function runExample() {
    ...
    orchestrator.registerSystem({
        systemId,
        initialStage: TemporalSequencer_1.AlignmentStage.INITIALIZATION,
        analysisConfig: {
    ...
    const codexAccess = new CodexAccess_1.CodexAccess();
    const resources = [
        {
